...
onready var text = get_parent().get_node("dialogue_win_sf").win_sf
...
func _physics_process(delta):
	...
	if $MikePlayer/TextBox2/Label.text == "Gremlin":
...
func _on_Button2_pressed():
	OS.shell_open("https://www.youtube.com/watch?v=_nIVzUrvREM")
